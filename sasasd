-- UI RESTORED BY WOJTES_BMW 
-- MAIN OWNER UI = ICY
local IceHub = {}



local GameTitle = "Ice Hub - Brookhaven | UI RESTORED BY WOJTES_BMW | " -- title
local titlecolor = Color3.fromRGB(0, 255, 255)
local labelcolor = Color3.fromRGB(255, 255, 255)
local owners = {"Owner1", "Owner2"} -- owners
local discord1 = "https://discord.gg/xzBCMYMn35" -- discord1
local discord2 = "https://discord.gg/xzBCMYMn35" -- discord2 if u want 3 just copy this local discord2 = "https://discord.gg/xzBCMYMn35"  and change 2 to 3 and paste  
...
function IceHub.CreateMain()
	...
	IcyImage.Image = "rbxassetid://130434941144456"
	...
	KickAll.Text = "UI RESTORED BY WOJTES_BMW"
	...
	IcyRoblox.Text = "Roblox : Wojtes_BMW"
	...
	IcyYoutube.Text = "Youtube : sanderxdev"
	...
	IcyDiscord.Text = "Discord : toniejaxdd"
	...
	NillestRoblox.Text = "Roblox : Examplenameroblox"
	...
	NillestDiscord.Text = "Discord : ExamplenameDiscord"
